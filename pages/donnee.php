...
<div class="panel-body">
    <div class="col-md-6">
        ...
        <form action="../libs/addSQL.php" method="post">
            ...
            <input type="text" class="form-control" name="prenom" placeholder="Prénom" required class="form-control">
        ...
        <form action="../libs/addSQL.php" method="post">
            ...
            <input type="text" class="form-control" name="mdp" placeholder="Mot de passe" required><br>
            <input type="text" class="form-control" name="nom" placeholder="Nom" required>
